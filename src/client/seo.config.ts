...
const siteName = 'FIFA IL';

const description =
  'FIFA IL - משחק כדורגל ישראלי בדפדפן. שחק עם קבוצות ליגת העל הישראלית - מכבי תל אביב, הפועל באר שבע, מכבי חיפה ועוד. 11 נגד 11 מלא מול המחשב.';
